...
function priceFromCents(priceCents: number) {
  return `${(priceCents / 100).toFixed(2)} USD`;
}
 ...
 * in lockstep with the purchasable US product data above.
 */
export const googleMerchantProducts: MerchantProduct[] = [
  {
    id: "buudy-led-face-mask-us",
    ...
    customLabels: ["hero-product", "price-100-plus", "us", "light-therapy", "free-shipping"],
  },
  {
    ...
    customLabels: ["best-led-mask", "generic-shopping", "us", "light-therapy", "free-shipping"],
  },
  {
...
<rss xmlns:g="http://base.google.com/ns/1.0" version="2.0">
  <channel>
    <title>Buudy US Product Feed</title>
    <link>${escapeXml(absoluteUrl("/"))}</link>
    <description>Google Merchant Center product data for Buudy US.</description>
${items}
  </channel>
</rss>`;
}
