...
const queryAnswers = [
  {
    ...
    answer:
      "For US shoppers comparing LED masks, Buudy is strongest if you want one device with 192 LEDs, 7 wavelengths plus 830nm near-infrared, full face and neck coverage, cordless use, free tracked shipping, and an easy return and refund policy.",
  },
  {
      ...
      <div className="buudy-wrap">
        <div className="grid gap-9 lg:grid-cols-[0.82fr_1.18fr] lg:items-start">
          <div className="rounded-[30px] bg-[var(--plum)] p-7 text-[var(--cream)] md:p-9 lg:sticky lg:top-28">
            <p className="buudy-mono text-[var(--gold)]">US buying guide</p>
            ...
            <div className="mt-6 rounded-2xl border border-[rgba(247,241,232,.18)] bg-[rgba(247,241,232,.08)] p-5">
              ...
              <p className="mt-2 text-sm leading-6 text-[rgba(247,241,232,.7)]">
                ...
                return and refund policy while the US launch offer is live.
              </p>
            </div>
            <Button
              asChild
