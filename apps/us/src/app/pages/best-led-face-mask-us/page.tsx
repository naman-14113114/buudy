...
const pageDescription =
  "A US buyer's guide to choosing the best LED face mask for red light therapy, blue light acne routines, anti-ageing skincare, near-infrared support, neck coverage, and value.";
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "best red light therapy mask US",
    "LED face mask acne US",
    "LED mask anti ageing US",
  ...
  twitter: {
    ...
    title: "Best LED Face Mask US 2026",
    description: pageDescription,
    ...
    <>
      ...
      <section className="buudy-section bg-[var(--plum)] py-16 text-[var(--cream)] md:py-24">
        <div className="buudy-wrap grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
          <div>
            <p className="buudy-mono text-[var(--gold)]">US LED mask guide</p>
            <h1 className="buudy-display mt-5 text-5xl leading-none md:text-7xl">
              Best LED Face Mask US: how to choose one that works for your routine.
            </h1>
            <p className="mt-6 max-w-2xl text-base leading-8 text-[rgba(247,241,232,.76)] md:text-lg">
              If you are comparing red light therapy masks in the US, focus on
          ...
          <figure className="relative min-h-[460px] overflow-hidden rounded-[34px] bg-[var(--ink)]">
            <Image
              alt="Buudy LED Mask used at home in the US"
        ...
        <div className="buudy-wrap">
          <div className="max-w-3xl">
            ...
            <h2 className="buudy-display mt-4 text-4xl leading-none text-[var(--plum)] md:text-6xl">
              For most US shoppers, the best LED face mask is the one with
      ...
      <section className="buudy-section bg-[rgba(241,223,210,.5)] py-16 md:py-24" id="comparison">
        <div className="buudy-wrap grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
          <div>
            ...
            <h2 className="buudy-display mt-4 text-4xl leading-none text-[var(--plum)] md:text-6xl">
              Built for the US buyer comparing premium LED masks.
            </h2>
