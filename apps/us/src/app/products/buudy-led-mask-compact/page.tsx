...
export const metadata: Metadata = {
  title: "Buudy LED Mask | Compact US Product Page",
  description:
    "A tighter Buudy LED Mask US product page with reviews earlier, compact expert video, and a faster path through the main buying sections.",
  alternates: {
    canonical: "/products/buudy-led-mask",
    languages: {
      "en-US": "/products/buudy-led-mask-compact",
    },
  },
  robots: {
    index: false,
