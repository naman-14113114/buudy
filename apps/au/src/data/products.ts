...
export const buudyMask: Product = {
  ...
  seoDescription:
    "Shop the Buudy LED Face Mask in Australia: 192 LEDs, red and blue light therapy, 830nm near-infrared mode, face plus neck coverage, cordless design, 90-day returns, and free glow kit.",
