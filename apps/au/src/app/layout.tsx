...
export const metadata: Metadata = {
  ...
  title: {
    default: "Best LED Face Mask Australia | Buudy Light Therapy",
    template: "%s | Buudy",
  },
  description:
    "Australia LED face mask for red light therapy, blue light acne routines, anti-ageing skincare, full face and neck coverage, and salon-grade home treatments.",
  ...
  openGraph: {
    ...
    url: market.siteUrl,
    locale: "en_AU",
    title: "Best LED Face Mask Australia | Buudy Light Therapy",
    description:
      "Salon-grade LED face and neck mask for Australian skincare routines with 192 LEDs, 7 wavelengths plus 830nm near-infrared, and a launch glow kit.",
    images: [
      {
