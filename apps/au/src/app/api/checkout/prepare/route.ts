...
async function createPlusbaseCheckout(
  ...
  let cookie = "X-Global-Market=AU; X-Global-Market-Currency=AUD; X-Lang=en-au; country_code=AU; currency=AUD";

  const requestHeaders: Record<string, string> = {
    accept: "application/json",
    cookie,
    "accept-language": clientHeaders?.acceptLanguage || "en-AU,en;q=0.9",
  };
