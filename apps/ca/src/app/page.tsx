...
export const metadata: Metadata = {
  title: "Best LED Face Mask Canada | Buudy Red Light Therapy",
  description:
    "Shop Buudy Canada for salon-grade LED face masks, red light therapy, blue light acne routines, anti-ageing skincare, near-infrared support, neck coverage, and free tracked shipping.",
  alternates: {
    canonical: "/",
  },
  keywords: [
