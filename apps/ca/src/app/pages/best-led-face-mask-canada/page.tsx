...
const pageTitle = "Best LED Face Mask Canada 2026: What to Look For";
const pageDescription =
  "A Canada buyer's guide to choosing the best LED face mask for red light therapy, blue light acne routines, anti-ageing skincare, near-infrared support, neck coverage, and value.";
...
const checkpoints = [
  ...
  {
    title: "Transparent Canada value",
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "best red light therapy mask Canada",
    "LED face mask acne Canada",
    "LED mask anti ageing Canada",
  ...
  twitter: {
    ...
    title: "Best LED Face Mask Canada 2026",
    description: pageDescription,
      ...
      <section className="buudy-section bg-[var(--plum)] py-16 text-[var(--cream)] md:py-24">
        <div className="buudy-wrap grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
          ...
          <figure className="relative min-h-[460px] overflow-hidden rounded-[34px] bg-[var(--ink)]">
            <Image
              alt="Buudy LED Mask used at home in Canada"
        ...
        <div className="buudy-wrap">
          <div className="max-w-3xl">
            ...
            <h2 className="buudy-display mt-4 text-4xl leading-none text-[var(--plum)] md:text-6xl">
              For most Canada shoppers, the best LED face mask is the one with
      ...
      <section className="buudy-section bg-[rgba(241,223,210,.5)] py-16 md:py-24" id="comparison">
        <div className="buudy-wrap grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
          <div>
            ...
            <h2 className="buudy-display mt-4 text-4xl leading-none text-[var(--plum)] md:text-6xl">
              Built for the Canada buyer comparing premium LED masks.
            </h2>
