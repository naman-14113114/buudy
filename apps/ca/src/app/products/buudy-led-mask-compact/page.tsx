...
export const metadata: Metadata = {
  title: "Buudy LED Mask | Compact Canada Product Page",
  description:
    "A tighter Buudy LED Mask Canada product page with reviews earlier, compact expert video, and a faster path through the main buying sections.",
  alternates: {
    canonical: "/products/buudy-led-mask",
    languages: {
      "en-CA": "/products/buudy-led-mask-compact",
    },
  },
  robots: {
    index: false,
