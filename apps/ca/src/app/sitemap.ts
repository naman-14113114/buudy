...
const routes = [
  ...
  { path: "/pages/best-led-face-mask-Canada", lastModified: "2026-06-05", changeFrequency: "weekly", priority: 0.95 },
  ...
  { path: "/policies/privacy-policy", lastModified: "2026-06-01", changeFrequency: "monthly", priority: 0.3 },
  { path: "/policies/terms-of-service", lastModified: "2026-06-01", changeFrequency: "monthly", priority: 0.3 },
  { path: "/policies/cookies-policy", lastModified: "2026-06-01", changeFrequency: "monthly", priority: 0.3 },
