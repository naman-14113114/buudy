...
function priceFromCents(priceCents: number) {
  return `${(priceCents / 100).toFixed(2)} CAD`;
}
 ...
 * in lockstep with the purchasable CA product data.
 */
export const googleMerchantProducts: MerchantProduct[] = [
  {
    id: "buudy-led-face-mask-ca",
    ...
    customLabels: ["hero-product", "price-100-plus", "ca", "light-therapy", "free-shipping"],
  },
  {
    id: "buudy-7-colour-led-mask-ca",
    title: "Buudy 7 Colour LED Light Therapy Face Mask - Red Light Therapy & 830nm NIR - Face & Neck Piece",
    description:
      "Buudy 7 Colour LED Face Mask delivers clinical-grade LED light therapy for home use. Features 7 visible light wavelengths plus 830 nm Near-Infrared (NIR) mode to stimulate collagen, reduce wrinkles, and clear acne. Full face and neck coverage with wireless tap controls. Includes USB-C charger, eye protection, and free CA$70 glow kit.",
    ...
    customLabels: ["best-led-mask", "generic-shopping", "ca", "light-therapy", "free-shipping"],
  },
  {
    id: "buudy-red-light-torch-ca",
    ...
    customLabels: ["accessory", "price-under-100", "ca", "light-therapy", "free-shipping"],
  },
];
...
<rss xmlns:g="http://base.google.com/ns/1.0" version="2.0">
  <channel>
    <title>Buudy CA Product Feed</title>
    <link>${escapeXml(absoluteUrl("/"))}</link>
    <description>Google Merchant Center product data for Buudy Canada.</description>
${items}
  </channel>
</rss>`;
}
