...
export const buudyMask: Product = {
  ...
  specs: [
    { label: "Dimensions", value: "20×29cm (7.87×11.42in)" },
    { label: "Number of LEDs", value: "192" },
    { label: "Intensity Level", value: "4 levels" },
    { label: "Light Modes", value: "7 colours + 830nm NIR" },
    { label: "Near-Infrared (NIR)", value: "830nm" },
    { label: "Battery Life", value: "12 sessions (1500mAh)" },
    { label: "Use Type", value: "Portable cordless LED mask" },
    { label: "Power Source", value: "Rechargeable battery" },
    { label: "Irradiance", value: "32 mW/cm²" },
