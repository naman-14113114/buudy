...
export function RitualSection() {
  return (
    <section className="buudy-section bg-[rgba(241,223,210,.42)] py-24">
      <div className="buudy-wrap grid items-center gap-10 lg:grid-cols-[1.2fr_1fr]">
        ...
        <div>
          ...
          <p className="buudy-copy mt-5">
            Discover how Buudy&apos;s 7 LED modes, flexible silicone fit, and simple
...
export function TouchTechSection() {
  return (
    <section className="buudy-section border-y border-[var(--border)] bg-[var(--plum)] py-24 text-[var(--cream)]">
      <div className="buudy-wrap grid items-center gap-14 lg:grid-cols-2">
        <div>
...
export function BlueLightSection() {
  return (
    <section className="buudy-section border-y border-[var(--border)] bg-[var(--ink)] py-24 text-[var(--cream)]">
      <div className="buudy-glow -left-40 top-1/2 h-[500px] w-[500px] -translate-y-1/2 bg-[#4a6acf]" />
      <div className="buudy-wrap relative z-10 grid items-center gap-12 lg:grid-cols-[1fr_1.4fr]">
